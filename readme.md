...
- Better identify and resolve common and uncommon "logical errors" that affect the results of your program
- Review using logs to troubleshoot errors in an application (console log in Dev Tools)
- Real-time debugging in the browser (start small, triangulation, remove code)
